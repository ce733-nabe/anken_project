    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tantousha', models.CharField(choices=[('0', 'Aさん'), ('1', 'Bさん'), ('2', 'Cさん')], max_length=200, verbose_name='担当者')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(blank=True, null=True, verbose_name='更新日時')),
                ('anken', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='akapp.anken', verbose_name='案件')),
            ],
        ),
    ]
